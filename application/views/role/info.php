                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" id="name" name="name" class="form-control" placeholder="请输入角色名称" value="<?php echo $data['name']?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">描述</label>
                                        <div class="">
                                            <input type="text" id="description" name="description" class="form-control" placeholder="请输入角色描述" maxlength="100" value="<?php echo $data['description']?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                                    ...
                                                    <tr class="groups">
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php foreach ($privilege_arr[$group_name] as $privilege):?>
                                                                <?php $privilege_ids = json_decode($data['privileges']); ?>
                                                                <div><input type="checkbox" class="privilege" value="<?php echo $privilege['privilege_id'];?>"
                                                                        <?php if (in_array($privilege['privilege_id'], $privilege_ids)) {echo "checked='checked'";} ?>>&nbsp;&nbsp;<?php echo $privilege['name'];?></div>
                                                            <?php endforeach;?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach;?>
                                    ...
                                    <div class="hidden">
                                        <input name="role_id" value="<?php echo $data['role_id']?>" />
...
<script>
    $(function () {
        ...
        $('tr.groups').each(function () {
            var $this = $(this);

            if ($this.find('.privilege:checked').length == $this.find('.privilege').length) {
                $this.find('.privilege_all')[0].checked = true;
            }
        });
        ...
        updateForm.find('#save').on('click', function (e) {
            if (valid.checkForm()) {
                try {
                    ...
                    setFormItemValue(updateForm, 'privileges', JSON.stringify(privileges));
