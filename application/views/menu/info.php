                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <select name="pid" class="pid form-control">
                                                <option value=1 <?php if ($data['pid'] == 1) {echo "selected='selected'";} ?>>作为一级菜单</option>
                                                <?php foreach ($menus_tree as $index=>$menu): ?>
                                                    <?php if ($menu['id'] > 1) : ?>
                                                        <option value="<?php echo $menu['id'] ?>" <?php if ($data['pid'] == $menu['id']) {echo "selected='selected'";} ?>>
                                                            <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" id="name" name="name" class="form-control" placeholder="请输入菜单名称" value="<?php echo $data['name'];?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <div class="file-upload child-inline-block">
                                                <div class="">
                                                    <input class="file-name form-control hidden" id="icon" name="icon" value="<?php echo $data['icon'];?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" id="url" name="url" class="form-control" placeholder="请输入菜单路由" value="<?php echo $data['url'];?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <label class=" control-label">
                                                <input type="radio" name="not_display" value=0 <?php if($data['not_display'] < 1){echo 'checked="checked"';}?>>
                                                是
                                            </label>
                                            &nbsp;&nbsp;
                                            <label class="control-label">
                                                <input type="radio" name="not_display" value=1 <?php if($data['not_display'] > 0){echo 'checked="checked"';}?>>
                                                否
                                            </label>
                                        </div>
                                    </div>
