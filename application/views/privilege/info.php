                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" id="name" name="name" class="form-control" placeholder="请输入权限名称" value="<?php echo $data['name']?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">路由</label>
                                        <div class="">
                                            <input type="text" id="url" name="url" class="form-control" placeholder="请输入路由" value="<?php echo $data['url']?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">权限组</label>
                                        <div class="">
                                            <input type="text" id="group_name" name="group_name" class="form-control" placeholder="请输入权限组" value="<?php echo $data['group_name']?>"/>
                                        </div>
                                    </div>
                                    <div class="hidden">
                                        <input name="privilege_id" value="<?php echo $data['privilege_id']?>" />
                                    </div>
                                </div>
                            </div>
